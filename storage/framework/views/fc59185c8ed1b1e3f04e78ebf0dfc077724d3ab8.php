...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('svg/resturant/logo3.png')); ?>">
...
<div class="nav-header" style="background: #fff;">
    <div class="brand-logo" style="padding: 0px!important;">
        <a href="">
            <b class="logo-abbr"><img src="<?php echo e(asset('svg/resturant/logo3.png')); ?>" alt=""> </b>
            <span class="logo-compact"><img src="<?php echo e(asset('svg/resturant/logo3.png')); ?>" alt=""></span>
            <span class="brand-title">
                        <img src="<?php echo e(asset('svg/resturant/logo3.png')); ?>" alt="" width="150" height="75">
                    </span>
        </a>
    </div>
</div>
...
<?php /**PATH D:\xampp\htdocs\lnp\resources\views/admin/layouts/layout.blade.php ENDPATH**/ ?>