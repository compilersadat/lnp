                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('offers.store')); ?>">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" id="disc" name="discription"></textarea>
                                        </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnp\resources\views/admin/offers/create.blade.php ENDPATH**/ ?>