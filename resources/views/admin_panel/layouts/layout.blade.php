...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('svg/resturant/logo3.png')}}">
...
<div class="nav-header" style="background: #fff;">
    <div class="brand-logo" style="padding: 0px!important;">
        <a href="">
            <b class="logo-abbr"><img src="{{asset('svg/resturant/logo3.png')}}" alt=""> </b>
            <span class="logo-compact"><img src="{{asset('svg/resturant/logo3.png')}}" alt=""></span>
            <span class="brand-title">
                        <img src="{{asset('svg/resturant/logo3.png')}}" alt="" width="150" height="75">
                    </span>
        </a>
    </div>
</div>
        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-sm">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{url('addcategory')}}">Add New</a></li>
