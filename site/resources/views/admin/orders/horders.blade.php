            ...
            <div class="row" style="border-top:1px solid gray">
                ...
                <div class="col-3  m-0 p-0" style="background:white;height:100vh;border-right:1px solid gray">
                    <ul class="metismenu" id="order_tab">
                    	@foreach(@App\Order::distinct()->where('status',"H")->orderBy('id','DESC')->get(['order_id']) as $row)
	                    <li class="p-3 @if($id==$row->order_id) active @endif" style="border-bottom: 1px solid #c9c9c9b3;">
	                        <a href="{{route('admin.hldorders',$row->order_id)}}"aria-expanded="false" class="p-3">
                ...
                <div class="col-9 p-0">
                	...
                	<div class="row p-0 m-0">
                			<div class="col-4">
                                    ...
                                    <div class="col-4">
                                    	<a href="{{route('admin.iporders',0)}}" class="text-primary"><b>InProcess </b></a>
                                    </div>
