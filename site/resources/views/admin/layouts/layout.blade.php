                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('sauces.index')}}">Sauces</a></li>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('coupens.create')}}">New Coupon</a></li>
                            <li><a href="{{route('coupens.index')}}">All Coupon</a></li>
...
<span class="nav-text">  Orders</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('admin.corders',0)}}">New Orders</a></li>
                            <li><a href="{{route('admin.hldorders',0)}}">Orders On Hold</a></li>
                            <li><a href="{{route('admin.iporders',0)}}">InProcess Orders</a></li>
                            <li><a href="{{route('admin.cmorders',0)}}">Completed Orders</a></li>
                            
                            <li><a href="{{route('admin.horders')}}">Order History/Reports</a></li>
                    ...
                    <li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{route('admin.users')}}">All Customers</a></li>
