            ...
            <div class="row" style="border-top:1px solid gray">
                ...
                <div class="col-3  m-0 p-0" style="background:white;height:100vh;border-right:1px solid gray">
                    <ul class="metismenu" id="order_tab">
                    	<?php $__currentLoopData = @App\Order::distinct()->where('status',"H")->orderBy('id','DESC')->get(['order_id']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                    <li class="p-3 <?php if($id==$row->order_id): ?> active <?php endif; ?>" style="border-bottom: 1px solid #c9c9c9b3;">
	                        <a href="<?php echo e(route('admin.hldorders',$row->order_id)); ?>"aria-expanded="false" class="p-3">
                ...
                <div class="col-9 p-0">
                	...
                	<div class="row p-0 m-0">
                        ...
                        <?php endif; ?>
                		<b><span class="text-danger">Order on Hold</span></b>
                		</p>
                    </div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/concordw/public_html/site/resources/views/admin/orders/horders.blade.php ENDPATH**/ ?>