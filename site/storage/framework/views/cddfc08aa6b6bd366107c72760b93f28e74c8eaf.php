            ...
            <div class="row" style="border-top:1px solid gray">
                ...
                <div class="col-3  m-0 p-0" style="background:white;height:100vh;border-right:1px solid gray">
                    <ul class="metismenu" id="order_tab">
                    	<?php $__currentLoopData = @App\Order::distinct()->where('status',"IP")->orderBy('id','DESC')->get(['order_id']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                    <li class="p-3 <?php if($id==$row->order_id): ?> active <?php endif; ?>" style="border-bottom: 1px solid #c9c9c9b3;">
	                        <a href="<?php echo e(route('admin.iporders',$row->order_id)); ?>"aria-expanded="false" class="p-3">
								...
								<div class="col-md-12 pl-4">
				                            ...
				                            <?php $__currentLoopData = @App\OrderSauce::where('order_id',$order->order_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sauce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<div class="row p-0 m-0">
													...
													<div class="col-10 pl-4">
														 <b>Sauce: </b><?php echo e(@App\Sauce::where('id',$sauce->sauce_id)->value('name')); ?><br>
													</div>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/concordw/public_html/site/resources/views/admin/orders/iporders.blade.php ENDPATH**/ ?>