                    ...
                    <div class="card " style="background: #d1d9e629;">
                        ...
                        <form class="text-center" style="color: #757575;" action="<?php echo e(route('login')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                                <!-- Email -->
                                <div class="md-form ">
                                    <input type="text" id="" name="email" placeholder="Enter Email" class="form-control text-center   btn-inside_se <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" style="border:none;" value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnp\site\resources\views/auth/login.blade.php ENDPATH**/ ?>