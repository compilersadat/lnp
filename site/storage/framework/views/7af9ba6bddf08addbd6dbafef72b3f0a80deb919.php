                                    ...
                                    <?php echo method_field('PATCH'); ?>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" id="sel1" name="parent_id">
                                                <option value="0" <?php if($cat->parent_id==0): ?> selected <?php endif; ?>>No Parent</option>
                                                <?php $__currentLoopData = @App\Category::where('parent_id',0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                	
                                            		<option value="<?php echo e($row->id); ?>"  <?php if($row->id==$cat->parent_id): ?> selected <?php endif; ?>><?php echo e($row->name); ?></option>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/concordw/public_html/site/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>