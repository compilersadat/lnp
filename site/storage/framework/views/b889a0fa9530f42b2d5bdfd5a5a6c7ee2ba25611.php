                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST"  action="<?php echo e(route('toppings.update',$topping->id)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnp\resources\views/admin/toppings/edit.blade.php ENDPATH**/ ?>