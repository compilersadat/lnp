                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST"  action="<?php echo e(route('toppings.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/concordw/public_html/site/resources/views/admin/toppings/create.blade.php ENDPATH**/ ?>